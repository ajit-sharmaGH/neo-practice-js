...
const mostActivePerson = (arr) => {
    // Your ES6+ code here
    const maxHoursObj = arr.reduce((maxHourObj, currentHourObj) => {
        const currentTotalHours = currentHourObj.hours.reduce((a, b) => a + b, 0);
        const maxTotalHours = maxHourObj.hours.reduce((a, b) => a + b, 0);
        return (currentTotalHours > maxTotalHours) ? currentHourObj : maxHourObj;
    });
